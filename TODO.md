...
> Backlog técnico gerado a partir de auditoria do **código real** (não do README) em 2026-09-04.
> Cada tarefa tem um ID único (`FIN-XXX`), prioridade, arquivos reais envolvidos e critérios de aceite objetivos.
> Este arquivo é a fonte da verdade sobre o estado do projeto — mantenha-o atualizado a cada tarefa concluída.
